...
class BookControllerTest {
    ...
    void createBook_Api_Success() throws Exception {
        ...
        BookDTO.BookResponse response = BookDTO.BookResponse.builder()
                .id(1L)
                .title("테스트 제목")
                .build();

        given(bookService.createBook(any(BookDTO.BookCreateRequest.class))).willReturn(response);
    ...
    void updateBook_Api_Success() throws Exception {
        ...
        given(bookService.updateBook(eq(1L), any(BookDTO.BookUpdateRequest.class))).willReturn(response);
